...
do
    ...
    mv ~/Documents/cpu_used_n* ~/Documents/cpu_used_sub_${sub_num}.txt
    mv ~/Documents/cpu_temp_n* ~/Documents/cpu_temp_sub_${sub_num}.txt
    mv ~/Documents/mem_used_n* ~/Documents/mem_used_sub_${sub_num}.txt
    mv ~/Documents/net_count_n* ~/Documents/net_count_sub_${sub_num}.txt
    mv ~/Documents/delay_n* ~/Documents/delay_sub_${sub_num}.txt
    sleep 30s
done
